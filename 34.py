...
class BasicalResNet(nn.Module):
    def __init__(self, channels):
        ...
        self.conv0 = nn.Conv2d(channels, channels, 5, padding=2)
        ...
        self.conv6 = nn.Conv2d(channels, channels, 5, padding=2)
        self.conv7 = nn.Conv2d(channels, channels, 5, padding=2)
...
class BasicalTResNet(nn.Module):
    def __init__(self, channels):
        ...
        self.tconv0 = nn.ConvTranspose2d(channels, channels, 5, padding=2)
        self.tconv1 = nn.ConvTranspose2d(channels, channels, 5, padding=2)
        self.tconv2 = nn.ConvTranspose2d(channels, channels, 5, padding=2)
        self.tconv3 = nn.ConvTranspose2d(channels, channels, 5, padding=2)
        self.tconv4 = nn.ConvTranspose2d(channels, channels, 5, padding=2)
        self.tconv5 = nn.ConvTranspose2d(channels, channels, 5, padding=2)
        self.tconv6 = nn.ConvTranspose2d(channels, channels, 5, padding=2)
        self.tconv7 = nn.ConvTranspose2d(channels, channels, 5, padding=2)
...
class EncodeNet(nn.Module):
    def __init__(self):
        ...
        self.conv1_0 = BasicalResNet(64)

        self.conv2 = nn.Conv2d(64, 32, 1)
        self.conv2_0 = BasicalResNet(32)
...
class DecodeNet(nn.Module):
    def __init__(self):
        ...
        self.tconv2_0 = BasicalTResNet(32)
        self.tconv2 = nn.ConvTranspose2d(32, 64, 1)

        self.tconv1_0 = BasicalTResNet(64)
