...
class EncodeNet(nn.Module):
    def __init__(self):
        ...
        self.conv1_0 = nn.Conv2d(128, 128, 5)
    ...
    def forward(self, x):
        ...
        # n*128*256*256 -> n*128*252*252
        xA = F.interpolate(x, (252, 252), mode='bilinear')
        xA = self.bn128_0(xA)
...
class DecodeNet(nn.Module):
    def __init__(self):
        ...
        self.tconv1_0 = nn.ConvTranspose2d(128, 128, 5)
